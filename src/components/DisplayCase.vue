		...
		<v-card class="pa-6">
			<v-row no-gutters align="center">
				...
				<v-col align="center" md="6">
					...
					<p>Le diagnostique a permis de révéler un crâne en dysfonction et quelques autres "blocages" au niveau de l'arrière train.</p>
					<p>J'ai donc effectué un traitement crânien, et des manipulations sur l'arrière train.</p>
					<p>J'ai conseillé un changement d'alimentation.</p>
			...
			<v-row no-gutters align="center">
				...
				<v-col md="6" align="center">
					...
					<p>Après un bilan ostéopathique complet et un diagnostique d'inclusion, il ressort , Phoenix présente quelques "blocages" au niveau du crâne, premières cervicales, lombaire, et quelques unes au niveau du postérieure.</p>
					<p>Après manipulation, phœnix se déplace mieux, a une meilleur récupération et respire de façon plus calme et ample.</p>
				</v-col>
			</v-row>
		</v-card>
	</v-container>
